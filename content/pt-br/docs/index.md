...
- **[Primeiros passos](/pt-br/docs/getting-started)** — requisitos, instalação, primeira execução e configuração.
- **[Conceitos](/pt-br/docs/concepts)** — como uma mensagem vira uma resposta: sessões, memória, compactação e confiança.

## Blocos de construção

- **[Canais](/pt-br/docs/channels)** — Telegram, WhatsApp, a interface de terminal e o dashboard web.
